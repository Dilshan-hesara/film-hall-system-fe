...
const ShiftReportModal: React.FC<ShiftReportModalProps> = ({ isOpen, onClose }) => {
  // 2. State එකට Type එක දීම
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      const res = await axios.get('https://film-hall-system-be.vercel.app/api/reports/daily');
            ...
            <>
              ...
              <div className="flex items-center justify-between bg-gray-700 p-4 rounded-lg border-l-4 border-green-500">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-200">Total Cash</span>
                </div>
