...
const FindBookingPage = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.get(`https://film-hall-system-be.vercel.app/api/bookings/${bookingId}`);
  ...
  const handleCancel = async () => {
    ...
    try {
      await axios.put(`https://film-hall-system-be.vercel.app/api/bookings/cancel/${bookingDetails._id}`);
