...
//   Calendar, Download, Edit2, Camera, ShieldCheck 
// } from 'lucide-react';
...
//   const [activeTab, setActiveTab] = useState<'profile' | 'bookings' | 'security'>('bookings'); // Default Tab
...
//               )}
//             </div>
//             <div className="absolute bottom-0 right-0 bg-green-500 w-6 h-6 rounded-full border-4 border-gray-800" title="Active"></div>
//           </div>
...
//                 className={`w-full flex items-center gap-3 px-6 py-4 transition-all border-l-4 ${activeTab === 'bookings' ? 'bg-gray-700/50 border-yellow-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-700/30 hover:text-gray-200'}`}
//               >
//                 <Ticket size={20} /> My Tickets
//               </button>
//               <button 
//                 onClick={() => setActiveTab('profile')}
//                 className={`w-full flex items-center gap-3 px-6 py-4 transition-all border-l-4 ${activeTab === 'profile' ? 'bg-gray-700/50 border-yellow-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-700/30 hover:text-gray-200'}`}
//               >
//                 <User size={20} /> Personal Details
//               </button>
//               <button 
//                 onClick={() => setActiveTab('security')}
//                 className={`w-full flex items-center gap-3 px-6 py-4 transition-all border-l-4 ${activeTab === 'security' ? 'bg-gray-700/50 border-yellow-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-700/30 hover:text-gray-200'}`}
//               >
...
//               className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl border border-red-900/30 text-red-400 hover:bg-red-900/20 transition-all font-semibold"
//             >
...
//                             <img src={booking.movie?.posterUrl} className="w-16 h-24 object-cover rounded-lg shadow-lg group-hover:scale-105 transition-transform" alt="Poster" />
//                             <div>
//                                 <h3 className="font-bold text-lg text-white mb-1">{booking.movie?.title}</h3>
//                                 <div className="text-sm text-gray-400 space-y-1">
//                                     <p className="flex items-center gap-2"><Calendar size={12}/> {booking.date} at {booking.time}</p>
//                                     <p className="text-gray-500">{booking.hall?.name}</p>
//                                 </div>
...
//                                     className="w-full bg-gray-900 border border-gray-600 rounded-lg p-3 pl-10 text-white focus:outline-none focus:border-yellow-500 transition-colors"
//                                 />
//                             </div>
//                         </div>
//                         <div>
...
//                                     value={user.email} 
//                                     disabled
//                                     className="w-full bg-gray-900 border border-gray-600 rounded-lg p-3 pl-10 text-white cursor-not-allowed"
//                                 />
//                             </div>
...
//                             <Camera className="absolute left-3 top-3.5 text-gray-500" size={18} />
//                             <input 
//                             type="url" 
//                             value={profileImage} 
...
//                         </div>
//                       </div>
//                       <p className="text-xs text-gray-500 mt-2">Paste a direct image link to update your avatar.</p>
//                     </div>
...
// 👇 SYSTEM AVATARS LIST (මේවා තමයි තෝරගන්න පුළුවන්)
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setUser(userData);
    setUsername(userData.username);
    // User ට කලින් Avatar එකක් තියෙනවා නම් ඒක ගන්න, නැත්නම් Default එක
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      const updatedUser = await updateUserProfile({
        userId: user._id,
        username,
        profileImage // 👇 තෝරාගත් Avatar URL එක Backend එකට යවනවා
      });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-800 rounded-xl border border-gray-700 p-6 md:p-8 min-h-[500px] shadow-xl">
              ...
              {/* TAB: MY BOOKINGS */}
              {activeTab === 'bookings' && (
                // ... (Booking Tab code - same as before) ...
                <div className="text-gray-400 text-center py-20">Your Booking History will appear here.</div>
              )}
